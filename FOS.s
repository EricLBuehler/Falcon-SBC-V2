...
fcl = $4 ; 2 bytes, ZP    |     This is the pointer to fcl
	...
	.include fcl_constants.s ;FCL constants
...
command_done:
	lda infcl
	beq command_done_notinfcl

	jmp fcl_command_done


command_done_notinfcl:
	stz address_buf
	stz address_buf
	lda #1
	sta cmddone
...
welcome_screen:
	...
	beq welcome_screen_no_highram
	cmp #1
	beq welcome_screen_512kb_highram
	cmp #2
	beq welcome_screen_1mb_highram

welcome_screen_no_highram:
	lda #<no_highram
	sta ptr_low
	lda #>no_highram
	sta ptr_high
	...
	bra welcome_screen_done_ramtest

welcome_screen_512kb_highram:
	lda #<fos_512_kb_highram
	sta ptr_low
	lda #>fos_512_kb_highram
	sta ptr_high
	jsr mov_ptr_charbuf
...
welcome_screen_1mb_highram:
	lda #<fos_1_mb_highram
	sta ptr_low
	lda #>fos_1_mb_highram
	sta ptr_high
	jsr mov_ptr_charbuf
